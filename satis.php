...
<script type="text/javascript">
    ...
    var myChart1 = new Chart(ctx, {
        ...
        options: {
            title: {
                display: true,
                text: '2021-2022 Bölgesel Satış Miktarları',
            }
...
<script type="text/javascript">
    ...
    var myChart2 = new Chart(ctx, {
        ...
        options: {
            title: {
                display: true,
                text: '2021-2022 Bölgesel Meyze-Sebze Satışı',
            }
...
<script type="text/javascript">
    ...
    var myChart3 = new Chart(ctx, {
        ...
        options: {
            title: {
                display: true,
                text: '2021-2022 Bölgesel Et-Balık-Tavuk Satışı',
            }
...
<script type="text/javascript">
    ...
    var myChart4 = new Chart(ctx, {
        ...
        options: {
            title: {
                display: true,
                text: '2021-2022 Bölgesel Temel Gıda Satışı',
            }
...
<script type="text/javascript">
    ...
    var myChart5 = new Chart(ctx, {
        ...
        options: {
            title: {
                display: true,
                text: '2021-2022 Bölgesel Temzilik Ürünleri Satışı',
            }
